...
#WATCH MARKERS
#
kameGKS = ProgramMarker.create(user_id: kame.id, program_id: gokusen.id, notes: 'Ano toki no ano basho, kienai kono kizuna.')
kameHYD = ProgramMarker.create(user_id: kame.id, program_id: hanadan.id, notes: 'Someone left a cake out in the rain.')
jinGKS = ProgramMarker.create(user_id: jin.id, program_id: gokusen.id, notes: 'Formation H!')
jinYN = ProgramMarker.create(user_id: jin.id, program_id: yamanade.id, notes: 'Kimi ga kirai na kimi ga suki...')


#
#WATCH MARKER PARTS
#
kameGKSs01 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksS01.id)
kameGKSsp01 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksSP01.id)
kameGKSs02 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksS02.id)
kameGKSsp02 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksSP02.id)
kameGKSs03 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksS03.id)
kameGKSsp03 = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksSP03.id)
kameGKSmovie = PartMarker.create(program_marker_id: kameGKS.id, part_id: gksMovie.id)

jinGKSs01 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksS01.id)
jinGKSsp01 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksSP01.id)
jinGKSs02 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksS02.id)
jinGKSsp02 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksSP02.id)
jinGKSs03 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksS03.id)
jinGKSsp03 = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksSP03.id)
jinGKSmovie = PartMarker.create(program_marker_id: jinGKS.id, part_id: gksMovie.id)
...
#Kame Gokusen
kameGKSs01e01 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E01.id, completed: true)
kameGKSs01e02 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E02.id)
kameGKSs01e03 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E03.id)
kameGKSs01e04 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E04.id)
kameGKSs01e05 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E05.id)
kameGKSs01e06 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E06.id)
kameGKSs01e07 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E07.id)
kameGKSs01e08 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E08.id)
kameGKSs01e09 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E09.id)
kameGKSs01e10 = EpisodeMarker.create(part_marker_id: kameGKSs01.id, episode_id: gksS01E10.id)

kameGKSsp01e01 = EpisodeMarker.create(part_marker_id: kameGKSsp01.id, episode_id: gksSP01E01.id)

kameGKSs02e01 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E01.id)
kameGKSs02e02 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E02.id)
kameGKSs02e03 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E03.id)
kameGKSs02e04 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E04.id)
kameGKSs02e05 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E05.id)
kameGKSs02e06 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E06.id)
kameGKSs02e07 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E07.id)
kameGKSs02e08 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E08.id)
kameGKSs02e09 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E09.id)
kameGKSs02e10 = EpisodeMarker.create(part_marker_id: kameGKSs02.id, episode_id: gksS02E10.id)

kameGKSsp02e01 = EpisodeMarker.create(part_marker_id: kameGKSsp02.id, episode_id: gksSP02E01.id)

kameGKSs03e01 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E01.id)
kameGKSs03e02 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E02.id)
kameGKSs03e03 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E03.id)
kameGKSs03e04 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E04.id)
kameGKSs03e05 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E05.id)
kameGKSs03e06 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E06.id)
kameGKSs03e07 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E07.id)
kameGKSs03e08 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E08.id)
kameGKSs03e09 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E09.id)
kameGKSs03e10 = EpisodeMarker.create(part_marker_id: kameGKSs03.id, episode_id: gksS03E10.id)

kameGKSsp03e01 = EpisodeMarker.create(part_marker_id: kameGKSsp03.id, episode_id: gksSP03E01.id)

kameGKSmovieE01 = EpisodeMarker.create(part_marker_id: kameGKSmovie.id, episode_id: gksMovieE01.id)

#Jin Gokusen
jinGKSs01e01 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E01.id, elapsed: 3128)
jinGKSs01e02 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E02.id, elapsed: 2001)
jinGKSs01e03 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E03.id, elapsed: 1048)
jinGKSs01e04 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E04.id, elapsed: 934)
jinGKSs01e05 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E05.id)
jinGKSs01e06 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E06.id)
jinGKSs01e07 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E07.id)
jinGKSs01e08 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E08.id)
jinGKSs01e09 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E09.id)
jinGKSs01e10 = EpisodeMarker.create(part_marker_id: jinGKSs01.id, episode_id: gksS01E10.id)

jinGKSsp01e01 = EpisodeMarker.create(part_marker_id: jinGKSsp01.id, episode_id: gksSP01E01.id)

jinGKSs02e01 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E01.id)
jinGKSs02e02 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E02.id)
jinGKSs02e03 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E03.id)
jinGKSs02e04 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E04.id)
jinGKSs02e05 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E05.id)
jinGKSs02e06 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E06.id)
jinGKSs02e07 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E07.id)
jinGKSs02e08 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E08.id)
jinGKSs02e09 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E09.id)
jinGKSs02e10 = EpisodeMarker.create(part_marker_id: jinGKSs02.id, episode_id: gksS02E10.id)

jinGKSsp02e01 = EpisodeMarker.create(part_marker_id: jinGKSsp02.id, episode_id: gksSP02E01.id)

jinGKSs03e01 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E01.id)
jinGKSs03e02 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E02.id)
jinGKSs03e03 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E03.id)
jinGKSs03e04 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E04.id)
jinGKSs03e05 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E05.id)
jinGKSs03e06 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E06.id)
jinGKSs03e07 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E07.id)
jinGKSs03e08 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E08.id)
jinGKSs03e09 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E09.id)
jinGKSs03e10 = EpisodeMarker.create(part_marker_id: jinGKSs03.id, episode_id: gksS03E10.id)

jinGKSsp03e01 = EpisodeMarker.create(part_marker_id: jinGKSsp03.id, episode_id: gksSP03E01.id)

jinGKSmovieE01 = EpisodeMarker.create(part_marker_id: jinGKSmovie.id, episode_id: gksMovieE01.id)